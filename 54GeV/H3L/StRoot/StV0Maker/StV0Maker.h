...
class StV0Maker : public StMaker {
  private:
    ...
    TH1D* deutronHisEta;
    TH1D* deutronHisPhi;
    TH1D* deutronHisRapidity;
    TH2D* deutronHisDedxP;
    TH2D* deutronZ_vs_p;
    TH2D* deutronDca_vs_p;
    ...
    TH1D* helium4HisEta;
    TH1D* helium4HisPhi;
    TH1D* helium4HisRapidity;
    TH2D* helium4HisDedxP;
    TH2D* helium4Z_vs_p;
    TH2D* helium4Dca_vs_p;
    ...
    vector<StPicoTrack*> mDauVec1;
    vector<StPicoTrack*> mDauVec2;
  ...
  public:
    StV0Maker(StPicoDstMaker* maker, const char* name);  // Constructor
