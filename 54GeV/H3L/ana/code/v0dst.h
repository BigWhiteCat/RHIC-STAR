...
// Fri Nov 16 10:23:06 2018 by ROOT version 5.34/30
// from TTree V0PicoDst/V0PicoDst from StV0Maker
// found on file: /star/u/pengliu/scratch/H3L/R17AuAu54GeV/picodst/la.picodst.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Float_t         vpdVz;
   Int_t           nv0;
   Float_t         v0mass[108];   //[nv0]
   Float_t         v0rapidity[108];   //[nv0]
   Float_t         v0eta[108];   //[nv0]
   Float_t         v0x[108];   //[nv0]
   Float_t         v0y[108];   //[nv0]
   Float_t         v0z[108];   //[nv0]
   Float_t         v0px[108];   //[nv0]
   Float_t         v0py[108];   //[nv0]
   Float_t         v0pz[108];   //[nv0]
   Float_t         v0xpath[108];   //[nv0]
   Float_t         v0ypath[108];   //[nv0]
   Float_t         v0zpath[108];   //[nv0]
   Float_t         v0pxpath[108];   //[nv0]
   Float_t         v0pypath[108];   //[nv0]
   Float_t         v0pzpath[108];   //[nv0]
   Float_t         v0pt[108];   //[nv0]
   Float_t         v0declen[108];   //[nv0]
   Float_t         v0declenH[108];   //[nv0]
   Float_t         v0dca[108];   //[nv0]
   Float_t         dca1to2[108];   //[nv0]
   Float_t         v0rdotp[108];   //[nv0]
   Float_t         v0theta[108];   //[nv0]
   Float_t         v0sinth[108];   //[nv0]
   Int_t           dau1id[108];   //[nv0]
   Float_t         dau1dca[108];   //[nv0]
   Float_t         dau1mass[108];   //[nv0]
   Int_t           dau1nhitsfit[108];   //[nv0]
   Int_t           dau1nhitsdedx[108];   //[nv0]
   Int_t           dau1nhitsmax[108];   //[nv0]
   Int_t           dau1hftbits[108];   //[nv0]
   Float_t         dau1eta[108];   //[nv0]
   Float_t         dau1nsigma[108];   //[nv0]
   Float_t         dau1px[108];   //[nv0]
   Float_t         dau1py[108];   //[nv0]
   Float_t         dau1pz[108];   //[nv0]
   Float_t         dau1pt[108];   //[nv0]
   Float_t         dau1dEdx[108];   //[nv0]
   Float_t         dau1Z[108];   //[nv0]
   Float_t         dau1beta[108];   //[nv0]
   Float_t         dau1diffinvbeta[108];   //[nv0]
   Float_t         dau1toflocaly[108];   //[nv0]
   Float_t         dau1toflocalz[108];   //[nv0]
   Int_t           dau2id[108];   //[nv0]
   Float_t         dau2dca[108];   //[nv0]
   Float_t         dau2mass[108];   //[nv0]
   Int_t           dau2nhitsfit[108];   //[nv0]
   Int_t           dau2nhitsdedx[108];   //[nv0]
   Int_t           dau2nhitsmax[108];   //[nv0]
   Int_t           dau2hftbits[108];   //[nv0]
   Float_t         dau2eta[108];   //[nv0]
   Float_t         dau2nsigma[108];   //[nv0]
   Float_t         dau2px[108];   //[nv0]
   Float_t         dau2py[108];   //[nv0]
   Float_t         dau2pz[108];   //[nv0]
   Float_t         dau2pt[108];   //[nv0]
   Float_t         dau2dEdx[108];   //[nv0]
   Float_t         dau2Z[108];   //[nv0]
   Float_t         dau2beta[108];   //[nv0]
   Float_t         dau2diffinvbeta[108];   //[nv0]
   Float_t         dau2toflocaly[108];   //[nv0]
   Float_t         dau2toflocalz[108];   //[nv0]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/star/u/pengliu/scratch/H3L/R17AuAu54GeV/picodst/la.picodst.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/star/u/pengliu/scratch/H3L/R17AuAu54GeV/picodst/la.picodst.root");
      }
...
void v0dst::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("dau1nhitsmax", dau1nhitsmax, &b_dau1nhitsmax);
   ...
   fChain->SetBranchAddress("dau2nhitsmax", dau2nhitsmax, &b_dau2nhitsmax);
