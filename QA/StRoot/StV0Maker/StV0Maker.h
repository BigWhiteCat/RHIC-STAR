...
class StV0Maker : public StMaker {
  private:
    ...
    // QA (begin)
    //******************************************************
    TString QATreeOutputFileName;
    TFile* QATreeOutputFile;
    TTree* QATree;
    QA objectQA;
    double PionMass, ProtonMass, DeutronMass, TritonMass, Helium3Mass, Helum4Mass;
    int PionCharge, ProtonCharge, DeutronCharge, TritonCharge, Helium3Charge, Helium4Charge;
    double pionTheory[11901];
    double protonTheory[11901];
    double deutronTheory[11901];
    double tritonTheory[11901];
    double helium3Theory[11901];
    double helium4Theory[11901];
    void setQATreeOutputFileName(TString name);
    void initQA();
    void initQAParameter();
    //*****************************************************
    // QA (end)
    //*****************************************************
